...
class OpenObamaWhiteHouseHarvestSpider(GenericCrawlHarvestSpider):
    ...
    def __init__(self, url=None, source_site=None, *args, **kwargs):
        super().__init__(
            url=url or 'https://open.obamawhitehouse.archives.gov',
            source_site=source_site or 'open.obamawhitehouse',
            *args, **kwargs,
        )
