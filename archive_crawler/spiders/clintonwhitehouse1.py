...
class ClintonWhiteHouse1Spider(SitemapUrlSpiderMixin, scrapy.Spider):
    ...
    SITEMAP_URL = 'https://clintonwhitehouse1.archives.gov/sitemap.xml'

    custom_settings = {
        'FEEDS': {
            'data/clintonwhitehouse1/clintonwhitehouse1_harvest.csv': {
                'format': 'csv',
                'overwrite': True,
