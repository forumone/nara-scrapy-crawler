...
class ClintonWhiteHouse3Spider(SitemapUrlSpiderMixin, scrapy.Spider):
    ...
    SITEMAP_URL = 'https://clintonwhitehouse3.archives.gov/sitemap.xml'

    custom_settings = {
        'FEEDS': {
            'data/clintonwhitehouse3/clintonwhitehouse3_harvest.csv': {
                'format': 'csv',
                'overwrite': True,
